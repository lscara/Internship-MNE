...
Name : Modèle FIRENZE v16 (zone dessinée)
Group : 
With QGIS : 32808
"""
...
class ModleFirenzeV16ZoneDessine(QgsProcessingAlgorithm):

    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterVectorLayer('communes_de_la_mayenne', 'Communes de la Mayenne', optional=True, types=[QgsProcessing.TypeVectorAnyGeometry], defaultValue=None))
        ...
        self.addParameter(QgsProcessingParameterFeatureSink('ZoneDtudeAvecCommunesAssignes', "Zone d'étude avec commune(s) assignée(s)", type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, defaultValue='C:/Users/lored/Documents/MNE/zone_etude.shp'))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback = QgsProcessingMultiStepFeedback(75, model_feedback)
        results = {}
        outputs = {}
        ...
        alg_params = {
            ...
            'INPUT_FIELDS': [''],
            'OVERLAY': parameters['communes_de_la_mayenne'],
            'OVERLAY_FIELDS': [''],
            'OVERLAY_FIELDS_PREFIX': '',
            'OUTPUT': parameters['ZoneDtudeAvecCommunesAssignes']
        }
        outputs['Intersection'] = processing.run('native:intersection', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['ZoneDtudeAvecCommunesAssignes'] = outputs['Intersection']['OUTPUT']
    ...
    def name(self):
        return 'Modèle FIRENZE v16 (zone dessinée)'
    ...
    def createInstance(self):
        return ModleFirenzeV16ZoneDessine()
