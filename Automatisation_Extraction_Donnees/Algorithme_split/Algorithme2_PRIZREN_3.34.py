...
Name : Modèle PRIZREN v16 (zone dessinée)
Group : 
With QGIS : 32808
"""
...
class ModlePrizrenV16ZoneDessine(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'JOIN': outputs['Intersection']['OUTPUT'],
            'JOIN_FIELDS': [''],
    ...
    def name(self):
        return 'Modèle PRIZREN v16 (zone dessinée)'
    ...
    def createInstance(self):
        return ModlePrizrenV16ZoneDessine()
